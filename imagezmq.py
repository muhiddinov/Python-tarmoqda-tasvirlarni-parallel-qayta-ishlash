...
class ImageSender():
    ...
    def init_reqrep(self, address):
        ...
        self.send_text  = self.send_text_reqrep
    ...
    def init_pubsub(self, address):
        ...
        self.send_text  = self.send_text_pubsub
    ...
    def send_text_reqrep(self, msg):
        self.zmq_socket.send_string(msg, copy=False)
        hub_reply = zmq_socket.recv()
        return hub_reply

    def send_text_pubsub(self, msg):
